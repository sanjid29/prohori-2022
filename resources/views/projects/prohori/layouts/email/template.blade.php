...
<head>
    ...
    @include('projects.prohori.layouts.email.includes.email-css')
    <title></title>
    @section('css')
        {{-- section: css --}}
    @show
...
<table class="content" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td class="header" width="100%" cellpadding="0" cellspacing="0">
            @section('title')
                {{-- section: title --}}
                {{-- @include('projects.prohori.layouts.email.includes.header')--}}
            @show
        </td>
    </tr>
            ...
            <table class="inner-body" align="center" width="650px" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="content-cell footer" width="100%" cellpadding="0" cellspacing="0">
                        @include('projects.prohori.layouts.email.includes.footer')
                    </td>
                </tr>
            </table>
        </td>
