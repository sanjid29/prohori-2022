 ...
 * @var \App\Department $element
 * @var \App\Department $department
 * @var \App\Tenant $tenant
 * @var \App\Projects\Prohori\Modules\Departments\DepartmentViewProcessor $view
 */
$department = $element;
?>
...
@section('js')
    @parent
    @include('projects.prohori.modules.departments.form.js')
@endsection