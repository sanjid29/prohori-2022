 ...
 * @var \App\Projects\DefaultProject\Modules\PushNotifications\PushNotificationViewProcessor $view
 */
...
@section('js')
    @parent
    @include('projects.default-project.modules.push-notifications.form.js')
@endsection