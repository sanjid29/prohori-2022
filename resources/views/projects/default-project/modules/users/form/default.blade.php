 ...
 * @var \App\Projects\DefaultProject\Modules\Users\UserViewProcessor $view
 */
?>
...
@section('content')
    <div class="col-md-12 col-lg-10 no-padding">
        ...
        <div class='clearfix'></div>
        {{-- @include('projects.default-project.modules.users.form.includes.token-fields')--}}
        <div class="clearfix"></div>
...
@section('js')
    @parent
    @include('projects.default-project.modules.users.form.js')
    <script>
        /***********************************************
