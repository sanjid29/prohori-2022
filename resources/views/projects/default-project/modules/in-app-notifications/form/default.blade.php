 ...
 * @var \App\Projects\DefaultProject\Modules\InAppNotifications\InAppNotificationViewProcessor $view
 */
...
@section('js')
    @parent
    @include('projects.default-project.modules.in-app-notifications.form.js')
@endsection