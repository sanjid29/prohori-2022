...
if (!isset($levels)) {
    $levels = [
        //['level' => 'division', 'model' => \App\Division::class, 'name' => 'division_id', 'label' => 'Division'],
        //['level' => 'district', 'model' => \App\District::class, 'name' => 'district_id', 'label' => 'District'],
        //['level' => 'upazila', 'model' => \App\Upazila::class, 'name' => 'upazila_id', 'label' => 'Upazila'],
        //['level' => 'paurasava', 'model' => \App\Paurasava::class, 'name' => 'paurasava_id', 'label' => 'Paurasava'],
        //['level' => 'union', 'model' => \App\Union::class, 'name' => 'union_id', 'label' => 'Union'],
