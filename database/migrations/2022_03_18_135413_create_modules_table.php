...
class CreateModulesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Modules';
        $module->namespace = '\\App\Projects\Prohori\Modules\Modules';
        $module->model = '\\App\Projects\Prohori\Modules\Modules\Module';
        $module->policy = '\\App\Projects\Prohori\Modules\Modules\ModulePolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Modules\ModuleProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Modules\ModuleController';
        $module->view_directory = 'projects.prohori.modules.modules';
