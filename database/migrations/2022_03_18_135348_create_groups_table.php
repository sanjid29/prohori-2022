...
class CreateGroupsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Groups';
        $module->namespace = '\\App\Projects\Prohori\Modules\Groups';
        $module->model = '\\App\Projects\Prohori\Modules\Groups\Group';
        $module->policy = '\\App\Projects\Prohori\Modules\Groups\GroupPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Groups\GroupProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Groups\GroupController';
        $module->view_directory = 'projects.prohori.modules.groups';
