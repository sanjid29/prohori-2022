...
class CreateCommentsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Comments';
        $module->namespace = '\\App\Projects\Prohori\Modules\Comments';
        $module->model = '\\App\Projects\Prohori\Modules\Comments\Comment';
        $module->policy = '\\App\Projects\Prohori\Modules\Comments\CommentPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Comments\CommentProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Comments\CommentController';
        $module->view_directory = 'projects.prohori.modules.comments';
