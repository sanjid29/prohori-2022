...
class CreateSpreadsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/DefaultProject/Modules/Spreads';
        $module->namespace = '\\App\Projects\DefaultProject\Modules\Spreads';
        $module->model = '\\App\Projects\DefaultProject\Modules\Spreads\Spread';
        $module->policy = '\\App\Projects\DefaultProject\Modules\Spreads\SpreadPolicy';
        $module->processor = '\\App\Projects\DefaultProject\Modules\Spreads\SpreadProcessor';
        $module->controller = '\\App\Projects\DefaultProject\Modules\Spreads\SpreadController';
        $module->view_directory = 'projects.default-project.modules.spreads';
