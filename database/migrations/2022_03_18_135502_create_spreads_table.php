...
class CreateSpreadsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Spreads';
        $module->namespace = '\\App\Projects\Prohori\Modules\Spreads';
        $module->model = '\\App\Projects\Prohori\Modules\Spreads\Spread';
        $module->policy = '\\App\Projects\Prohori\Modules\Spreads\SpreadPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Spreads\SpreadProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Spreads\SpreadController';
        $module->view_directory = 'projects.prohori.modules.spreads';
