...
class CreateChangesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Changes';
        $module->namespace = '\\App\Projects\Prohori\Modules\Changes';
        $module->model = '\\App\Projects\Prohori\Modules\Changes\Change';
        $module->policy = '\\App\Projects\Prohori\Modules\Changes\ChangePolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Changes\ChangeProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Changes\ChangeController';
        $module->view_directory = 'projects.prohori.modules.changes';
