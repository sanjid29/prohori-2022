...
class CreateInAppNotificationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/InAppNotifications';
        $module->namespace = '\\App\Projects\Prohori\Modules\InAppNotifications';
        $module->model = '\\App\Projects\Prohori\Modules\InAppNotifications\InAppNotification';
        $module->policy = '\\App\Projects\Prohori\Modules\InAppNotifications\InAppNotificationPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\InAppNotifications\InAppNotificationProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\InAppNotifications\InAppNotificationController';
        $module->view_directory = 'projects.prohori.modules.in-app-notifications';
