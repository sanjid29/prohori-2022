...
class CreateInAppNotificationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/DefaultProject/Modules/InAppNotifications';
        $module->namespace = '\\App\Projects\DefaultProject\Modules\InAppNotifications';
        $module->model = '\\App\Projects\DefaultProject\Modules\InAppNotifications\InAppNotification';
        $module->policy = '\\App\Projects\DefaultProject\Modules\InAppNotifications\InAppNotificationPolicy';
        $module->processor = '\\App\Projects\DefaultProject\Modules\InAppNotifications\InAppNotificationProcessor';
        $module->controller = '\\App\Projects\DefaultProject\Modules\InAppNotifications\InAppNotificationController';
        $module->view_directory = 'projects.default-project.modules.in-app-notifications';
