...
class CreateClientLocationTypesTable extends Migration
{
    ...
    public function up()
    {
        ...
        |---------------------------------*/
        if (!Schema::hasTable('client_location_types')) {
        ...
        $module->module_table = 'client_location_types';
        $module->route_path = 'client-location-types';
        $module->route_name = 'client-location-types';
        $module->default_route = 'client-location-types';
        $module->class_directory = 'app/Projects\Prohori\Modules\ClientLocationTypes';
        $module->namespace = '\\App\Projects\Prohori\Modules\ClientLocationTypes';
        $module->model = '\\App\Projects\Prohori\Modules\ClientLocationTypes\ClientLocationType';
        $module->policy = '\\App\Projects\Prohori\Modules\ClientLocationTypes\ClientLocationTypePolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\ClientLocationTypes\ClientLocationTypeProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\ClientLocationTypes\ClientLocationTypeController';
        $module->view_directory = 'projects.prohori.modules.client-location-types';
    ...
    {
        Schema::dropIfExists('client_location_types');
    }
}