...
class CreateModuleGroupsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/ModuleGroups';
        $module->namespace = '\\App\Projects\Prohori\Modules\ModuleGroups';
        $module->model = '\\App\Projects\Prohori\Modules\ModuleGroups\ModuleGroup';
        $module->policy = '\\App\Projects\Prohori\Modules\ModuleGroups\ModuleGroupPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\ModuleGroups\ModuleGroupProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\ModuleGroups\ModuleGroupController';
        $module->view_directory = 'projects.prohori.modules.module-groups';
