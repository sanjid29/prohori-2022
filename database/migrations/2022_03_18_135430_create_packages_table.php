...
class CreatePackagesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Packages';
        $module->namespace = '\\App\Projects\Prohori\Modules\Packages';
        $module->model = '\\App\Projects\Prohori\Modules\Packages\Package';
        $module->policy = '\\App\Projects\Prohori\Modules\Packages\PackagePolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Packages\PackageProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Packages\PackageController';
        $module->view_directory = 'projects.prohori.modules.packages';
