...
class CreatePackagesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/DefaultProject/Modules/Packages';
        $module->namespace = '\\App\Projects\DefaultProject\Modules\Packages';
        $module->model = '\\App\Projects\DefaultProject\Modules\Packages\Package';
        $module->policy = '\\App\Projects\DefaultProject\Modules\Packages\PackagePolicy';
        $module->processor = '\\App\Projects\DefaultProject\Modules\Packages\PackageProcessor';
        $module->controller = '\\App\Projects\DefaultProject\Modules\Packages\PackageController';
        $module->view_directory = 'projects.default-project.modules.packages';
