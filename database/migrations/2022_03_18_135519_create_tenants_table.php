...
class CreateTenantsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/DefaultProject/Modules/Tenants';
        $module->namespace = '\\App\Projects\DefaultProject\Modules\Tenants';
        $module->model = '\\App\Projects\DefaultProject\Modules\Tenants\Tenant';
        $module->policy = '\\App\Projects\DefaultProject\Modules\Tenants\TenantPolicy';
        $module->processor = '\\App\Projects\DefaultProject\Modules\Tenants\TenantProcessor';
        $module->controller = '\\App\Projects\DefaultProject\Modules\Tenants\TenantController';
        $module->view_directory = 'projects.default-project.modules.tenants';
