...
class CreateTenantsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Tenants';
        $module->namespace = '\\App\Projects\Prohori\Modules\Tenants';
        $module->model = '\\App\Projects\Prohori\Modules\Tenants\Tenant';
        $module->policy = '\\App\Projects\Prohori\Modules\Tenants\TenantPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Tenants\TenantProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Tenants\TenantController';
        $module->view_directory = 'projects.prohori.modules.tenants';
