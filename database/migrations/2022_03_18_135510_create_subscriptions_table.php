...
class CreateSubscriptionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Subscriptions';
        $module->namespace = '\\App\Projects\Prohori\Modules\Subscriptions';
        $module->model = '\\App\Projects\Prohori\Modules\Subscriptions\Subscription';
        $module->policy = '\\App\Projects\Prohori\Modules\Subscriptions\SubscriptionPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Subscriptions\SubscriptionProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Subscriptions\SubscriptionController';
        $module->view_directory = 'projects.prohori.modules.subscriptions';
