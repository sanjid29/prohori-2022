...
class CreateSubscriptionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/DefaultProject/Modules/Subscriptions';
        $module->namespace = '\\App\Projects\DefaultProject\Modules\Subscriptions';
        $module->model = '\\App\Projects\DefaultProject\Modules\Subscriptions\Subscription';
        $module->policy = '\\App\Projects\DefaultProject\Modules\Subscriptions\SubscriptionPolicy';
        $module->processor = '\\App\Projects\DefaultProject\Modules\Subscriptions\SubscriptionProcessor';
        $module->controller = '\\App\Projects\DefaultProject\Modules\Subscriptions\SubscriptionController';
        $module->view_directory = 'projects.default-project.modules.subscriptions';
