...
class CreateContentsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Projects/Prohori/Modules/Contents';
        $module->namespace = '\\App\Projects\Prohori\Modules\Contents';
        $module->model = '\\App\Projects\Prohori\Modules\Contents\Content';
        $module->policy = '\\App\Projects\Prohori\Modules\Contents\ContentPolicy';
        $module->processor = '\\App\Projects\Prohori\Modules\Contents\ContentProcessor';
        $module->controller = '\\App\Projects\Prohori\Modules\Contents\ContentController';
        $module->view_directory = 'projects.prohori.modules.contents';
