...
{
    use PushNotificationProcessorTrait, PushNotificationProcessorHelper;
    ...
    */
    ...
    {
        $rules = [
            // 'name' => 'required|between:1,100|'.'unique:push_notifications,name,'.($element->id ?? 'null').',id,deleted_at,NULL',
            'is_active' => 'in:1,0',
        ];
