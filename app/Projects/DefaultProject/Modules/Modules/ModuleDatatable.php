...
use App\Projects\DefaultProject\Features\Datatable\ModuleDatatable as MfModuleDatatable;

class ModuleDatatable extends MfModuleDatatable
{
    ...
    //     return Module::with(['updater:id,name']); // Model based query.
    // }
