...
use App\ClientLocationType;

class ClientLocationTypeProcessor extends ModelProcessor
{
    // Note: Pull in necessary traits
    use ClientLocationTypeProcessorHelper;
    ...
    */
     ...
     *
     * @param  ClientLocationType  $element
     * @return $this
     */
    ...
    {
        $rules = [
            'name' => 'required|between:1,100|'.'unique:client_location_types,name,'.($element->id ?? 'null').',id,deleted_at,NULL',
            'is_active' => 'in:1,0',
        ];
