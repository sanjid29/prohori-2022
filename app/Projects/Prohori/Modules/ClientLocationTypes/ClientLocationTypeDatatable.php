...
class ClientLocationTypeDatatable extends ModuleDatatable
{
    // Note: Pull in necessary traits

    public $moduleName = 'client-location-types';
    ...
    public function source()
    {
        ...
        return ClientLocationType::with(['updater:id,name']); // Model based query.
    }
