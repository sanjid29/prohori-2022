...
use App\Projects\Prohori\Features\Modular\BaseModule\BaseModuleObserver;
use App\ClientLocationType;

class ClientLocationTypeObserver extends BaseModuleObserver
{
    // Note: Pull in necessary traits from relevant mainframe class

    // /**
    //  * @param  App\ClientLocationType  $element
    //  * @return void|bool
    //  */
